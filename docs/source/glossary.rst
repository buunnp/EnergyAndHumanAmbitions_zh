...
.. glossary:: 
    ...
    biomass
     is a generic term for biological matter, but in the :term:`energy` context usually means
    ...
    Chart of the Nuclides
     ...
     including mass or :term:`energy`, abundance (if stable), :term:`half life` (if
    ...
    chemical energy
     is :term:`energy` stored in chemical bonds, like gasoline or wood that might be burned,
    ...
    CSP
     (CSP) refers to a form of :term:`solar thermal` (ST) :term:`energy`, employing troughs
    ...
    conduction band
     is the :term:`energy` level a step up from that of :term:`electrons<electron>` in the
    ...
    EPM
     ...
     at the state level from all :term:`energy` sources.
    ...
    energy density
     describes how concentrated :term:`energy` is in a substance, quantified as energy per
    ...
    energy trap
     refers to a phenomenon in which :term:`energy` shortage motivates aggressive pursuit of
     alternative energy schemes, but that pursuit requires substantial :term:`energy`
    ...
    EROEI
     Energy Returned on Energy Invested: a measure of how profitable an :term:`energy` source
    ...
    flexitarianism
     ...
     :term:`energy` costs in an effort to keep the :term:`dietary energy factor` low,
    ...
    gravitational potential energy
     is the :term:`energy` stored in a mass, m, lifted a height, h, above some reference in
     the presence of gravity, g ≈ 10 m/s\ :sup:`2`. The :term:`energy` amounts to mgh, and
    ...
    heat of fusion
     is the :term:`energy` barrier associated with either forming (fusing) or melting a solid
     from a liquid. In the case of water (ice), the heat of fusion is 335 J per gram.

    heat of vaporization
     is the :term:`energy` barrier associated with turning a liquid into gas. In the case of
    ...
    life-cycle CO2 emission
     is an assessment of how much CO\ :sub:`2` is released from an :term:`energy` source
    ...
    nuclear binding energy
     is the :term:`energy` associated with the strong nuclear force that holds a
    ...
    recombination
     ...
     :term:`energy` it had becomes unrecoverable.
    ...
    tokamak
     ...
     :term:`confined`, and potentially used to generate :term:`fusion`.
    ...
    valence band
     is the :term:`energy` level of outer :term:`electrons<electron>` bound to an atom.
